    ...
    if len(text) > 7:
        ...
        if FILE_AUTO_DELETE > 0:
            notification_msg = await message.reply(
                f"<b>This file will be deleted in <a href=https://t.me/Flix_Dex>{get_exp_time(FILE_AUTO_DELETE)} </a>. Please save or forward it to your saved messages before it gets deleted.<b>\n\nHelpline @EternalsHelplineBot</b>"
            )
