    ...
    if id in ADMINS:
        ...
        if TOKEN:
            ...
            if not verify_status['is_verified']:
                ...
                return await message.reply(
                    f"<b><a><blockquote>Your Ads token is expired, refresh your token and try again</blockquote></a></b>\n\n<b>Token Timeout:</b> {get_exp_time(VERIFY_EXPIRE)}\n\n<b>ᴡʜᴀᴛ ɪs ᴛʜᴇ ᴛᴏᴋᴇɴ??</a></b>\n<b><a>ᴛʜɪs ɪs ᴀɴ ᴀᴅs ᴛᴏᴋᴇɴ. ᴘᴀssɪɴɢ ᴏɴᴇ ᴀᴅ ᴀʟʟᴏᴡs ʏᴏᴜ ᴛᴏ ᴜsᴇ ᴛʜᴇ ʙᴏᴛ ғᴏʀ {get_exp_time(VERIFY_EXPIRE)</a></b>\n\n<b><a>APPLE/IPHONE USERS COPY TOKEN LINK AND OPEN IN CHROME BROWSER</a></b>\n\n<b><a><blockquote>Important Notice‼️Once you click on the link do not go back/skip or close the link if you close the line your token will expire. If you accidentally close the link /start the bot and verify again‼️</blockquote></a></b>\n<a><b><blockquote expandable>We are adding a token system. So that our work can continue like this. Because we are not earning anything by doing this all, that is why we are adding a token system. I hope you guys will still support us</blockquote expandable></a></b></a>\nHᴇʟᴘʟɪɴᴇ ʙᴏᴛ @EternalsHelplineBot",
